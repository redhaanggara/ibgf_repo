	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="top-nav">
		...
		<div class="navbar-header">
			...
			<div class="nav navbar-nav navbar-right">
				<li><a href="http://palhub.azurewebsites.net/index.php/person/logout">Logout</a></li>
			</div>
		</div>
	 </nav>
</div>
    ...
    <div class="container">
	    ...
	    <thead>
	    	...
	    	<tr>
	    		...
	    		<td><a href="http://palhub.azurewebsites.net/index.php/person/admin_update_pendaftar?id=<?php echo  $row->id; ?>" class="btn btn-primary" class="btn btn-primary">Update</a> <a href="http://palhub.azurewebsites.net/index.php/person/admin_delete_pendaftar?id=<?php echo  $row->id; ?>" class="btn btn-danger">Delete</a></td>
