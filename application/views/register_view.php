...
<br><br>
	...
	<div class="container">
	<h3><a href="http://palhub.azurewebsites.net/index.php/main/home_page"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp Home Page</a></h3>
	<center><h2>Registrasi PBGF 2017</h2></center>
		<div class="row">
			<div class="control-group" id="fields">
				<div class="controls">
					<form role="form" autocomplete="off" action="http://palhub.azurewebsites.net/index.php/person/insert_regis" method="post">
