...
<?php foreach ($post as $key) { ?>
  ...
  <div class="container">
  	 <h3><a href="http://palhub.azurewebsites.net/index.php/person/get_data_pendaftar"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp Back</a></h3>
  <br>
  ...
  <br>
  	<div class="row">
			<div class="control-group" id="fields">
				<div class="controls">
					<form role="form" autocomplete="off" action="http://palhub.azurewebsites.net/index.php/person/admin_save_update?id=<?php echo  $key->id; ?>" method="post">
